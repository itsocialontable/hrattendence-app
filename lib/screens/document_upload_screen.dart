...
class _DocumentUploadScreenState extends State<DocumentUploadScreen>
  ...
  Future<void> _fetchDocs() async {
    ...
    try {
      ...
      final res = await http.get(
        Uri.parse('$_baseUrl/api/documents/$_userId'),
        headers: {
        ...
        setState(() {
          for (final sd in serverDocs) {
            ...
            doc.viewUrl = sd.viewUrl.isNotEmpty
                ? sd.viewUrl
                : '$_baseUrl/api/documents/$_userId/${sd.docType}/view';
          }
        });
  ...
  Future<void> _viewDoc(DocumentItem doc) async {
    ...
    try {
      final url = doc.viewUrl ??
          '$_baseUrl/api/documents/$_userId/${doc.docType}/view';
  ...
  Future<void> _deleteDoc(DocumentItem doc) async {
    ...
    try {
      final url = '$_baseUrl/api/documents/$_userId/${doc.docType}';
      log('🗑 DELETE: $url');
